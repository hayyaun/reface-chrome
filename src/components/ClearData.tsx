...
export default function ClearData() {
  ...
  return (
    <li className="odd-color flex items-center justify-between gap-4 p-2 py-1 pl-4 transition select-none">
      <Label name="Clear Data" details="Clears all data stored on this device." limit={400} lines={null} />
      <div aria-label="Buttons" className="flex h-12 gap-2 py-2">
        <button className="text-btn group/icon text-red-300 hover:bg-red-500/25" onClick={onClick}>
          Clear data
